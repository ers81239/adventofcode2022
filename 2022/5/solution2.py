...
class Ship:
    ...
    def execute_command(self, command: Command):
        ...
        crates = self.stacks[command.from_stack][-command.count:]
        self.stacks[command.from_stack] = self.stacks[command.from_stack][:-command.count]
        self.stacks[command.to_stack].extend(crates)
        pass
